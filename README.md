...
<ol>
  ...
  <li>
   ...
   <ul>
   <li>While Pasting this into fpv-camera service add single quotes(') where ever there is bracket else the kernel will through error at opening brackets.</li></ul>
    </ul>
  </li>
</ol>
